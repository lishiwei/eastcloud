...
public class AutoTextView extends TextSwitcher implements
    ...
    public AutoTextView(Context context, AttributeSet attrs) {
        ...
        mHeight = a.getDimension(R.styleable.auto3d_textSize, 20);
        a.recycle();
        mContext = context;
        init();
    }
    ...
    public void start() {
        if (mDisposable == null) {
            mDisposable = Flowable.interval(0, 5, TimeUnit.SECONDS).subscribeOn(Schedulers.newThread()).observeOn(AndroidSchedulers.mainThread())
