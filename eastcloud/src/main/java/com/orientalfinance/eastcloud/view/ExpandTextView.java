...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        titleTextSize = a.getDimension(R.styleable.ExpandTextView_titleTextSize, DensityUtil.sp2px(DEFAULT_TITLE_TEXT_SIZE));
        contentTextSize = a.getDimension(R.styleable.ExpandTextView_contentTextSize, DensityUtil.sp2px(DEFAULT_CONTENT_TEXT_SIZE));
        hintTextSize = a.getDimension(R.styleable.ExpandTextView_hintTextSize, DensityUtil.sp2px(DEFAULT_HINT_TEXT_SIZE));
    ...
    public void setTitleTextSize(float titleTextSize) {
        this.titleTextSize = DensityUtil.sp2px(titleTextSize);
    ...
    public void setContentTextSize(float contentTextSize) {
        this.contentTextSize = DensityUtil.sp2px(contentTextSize);
    ...
    public void setHintTextSize(float hintTextSize) {
        this.hintTextSize = DensityUtil.sp2px(hintTextSize);
    ...
    public int getMinMeasureHeight() {
        if (copy == null) {
            ...
            copy.setLineSpacing(DensityUtil.dp2px(6), 1.0f);
