        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    MyTVRvAdpter.MyTVViewHolder viewHolder = (MyTVRvAdpter.MyTVViewHolder) getChildViewHolder(view);
                    Log.d("layout", "onTouchEvent: "+viewHolder.layout);
            ...
            case MotionEvent.ACTION_MOVE:
                int dx = mLastX - x;
                int dy = mLastY - y;
                LogUtils.d("layout", "onTouchEvent: ");
