...
public class MainGuideDialog extends Dialog {
    ...
    public MainGuideDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected MainGuideDialog(Context context, boolean cancelable,
    ...
    public static class Builder {
        ...
        public MainGuideDialog create() {
            /**
             * 利用我们刚才自定义的样式初始化Dialog
             */
            final MainGuideDialog dialog = new MainGuideDialog(context,
                    R.style.guide_dialog);
            /**
             * 下面就初始化Dialog的布局页面
             */
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View dialogLayoutView = inflater.inflate(R.layout.guide_dialog_layout,
                    null);
