...
public class History {
    ...
    public History(String channelLogo, String programId, String id, String currentProgramBg, String channelName, String currentProgram, String programTime) {
    ...
    public History(String currentProgramBg, String channelName, String currentProgram, String channelLogo, String programTime) {
        this.currentProgramBg = currentProgramBg;
        this.channelName = channelName;
        this.currentProgram = currentProgram;
        this.channelLogo = channelLogo;
    ...
    public History(String currentProgramBg, String channelName, String currentProgram, String programTime) {
        this.currentProgramBg = currentProgramBg;
        this.channelName = channelName;
        this.currentProgram = currentProgram;
        this.programTime = programTime;
